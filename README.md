...
- Status: `P3-036 current implementation gates PASS; closure CI pending`
- Candidate: `None`
- Release Readiness: `v1.1.0 PASS; v1.2 candidate not assigned`
- Latest gate: `P3-036 exact-SHA diagnostic CI PASS; historical Graph incident open`
...
P3-036 canonical task: `docs/tasks/P3-036_WORKSPACE_MUTATION_FOCUS_CONTINUITY.md` (implementation gates PASS; closure CI pending).
P3-036 evidence: `docs/P3_036_WORKSPACE_MUTATION_FOCUS_CONTINUITY_REPORT.md` (current full local and exact-SHA CI PASS; historical Graph incident remains open, sections 17-20).
...
- Active task: `None`
- Staged task: `None`
- Status: `P3-036 REOPENED / CI EVIDENCE REPAIR`
