...
- Latest gate: `P3-036 replacement browser and exact-SHA CI validation pending`
- Current task: `P3-036 E2E evidence repair`
...
P3-036 canonical task: `docs/tasks/P3-036_WORKSPACE_MUTATION_FOCUS_CONTINUITY.md` (REOPENED / CI EVIDENCE REPAIR).
P3-036 evidence: `docs/P3_036_WORKSPACE_MUTATION_FOCUS_CONTINUITY_REPORT.md` (focus continuity and current route-evidence repair).
