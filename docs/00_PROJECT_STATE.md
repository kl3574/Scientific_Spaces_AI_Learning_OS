...
P3-023 Concept Study Set and Learning Launch: IN PROGRESS
...
P3-023 APPROVED / IN PROGRESS; TWO INDEPENDENT REVISED-SCOPE REVIEWS PASS

Implementation Authorization:

P3-023 FRONTEND / TEST / DOCUMENTATION / LOCAL ARTICLE AND GRAPH READ / BROWSER-LOCAL SESSION WRITE / FAKE-PROVIDER RUNTIME / LOCAL COMMIT / NON-FORCE MAIN PUSH / EXACT-SHA CI READBACK GRANTED; BACKEND / FROZEN M1 / SOURCE / ARTICLE / DERIVED ASSET / DEPENDENCY / LOCKFILE / WORKFLOW / PUBLISHED API / EXTERNAL / PRIVATE ZOTERO / REAL PROVIDER / RELEASE ACTIONS NOT GRANTED
