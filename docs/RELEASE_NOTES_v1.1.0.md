...
- Final notes for GitHub Release v1.1.0.
- Draft status removed after release publication.


## Highlights

`v1.1.0` is an operational-maturity and full-local-corpus release. P2-008 restores the frozen Article and Graph contracts, moves scalable list/query behavior to explicit `/v1.1` endpoints, and adds identity-preserving Learning JSON/SQLite migration.
